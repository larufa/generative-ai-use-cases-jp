...
* <画像情報></画像情報>は領収書に関する情報です。情報がある場合はその請求書が<参考ドキュメント></参考ドキュメント>をもとに申請可能かどうかを判断し、「この請求書は申請できます」あるいは「この請求書は申請できません」のどちらかから始めてください。
* <画像情報></画像情報>について請求可能かを判断し、請求可能な場合は画像情報から情報を抜き出し、申請に必要な情報を出力してください。
* <画像情報></画像情報>がない場合は画像を要求添付するようにユーザに促してください。
</回答のルール>

<画像情報>
${params.detectedText ? params.detectedText : ''}
</画像情報>
`;
    }
  },
